...
try {
    ...
    echo "<!-- First Record: " . print_r($records[0] ?? 'No records', true) . " -->";
    ...
    $stmt = $pdo->prepare("SELECT * FROM tbl_visit ORDER BY visit_date DESC");
    $stmt->execute();
...
<body>
    ...
    var students = <?php echo json_encode($activeStudents); ?>;
    var bounds = [];
