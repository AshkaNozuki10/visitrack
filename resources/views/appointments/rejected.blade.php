    ...
    <div class="row">
                ...
                <nav class="mt-4">
                    ...
                    <div class="mb-2">
                        ...
                        <div class="sub-menu">
                            ...
                            <a href="{{ route('appointments.rejected') }}" class="sidebar-link mb-1 active">Rejected</a>
                            <a href="{{ route('appointments.pending') }}" class="sidebar-link mb-1">Pending</a>
                        </div>
                    </div>
        ...
        <div class="col-md-9 col-lg-10 p-4">
            <div class="card shadow">
                <div class="card-body">
                    <h2 class="card-title mb-4">REJECTED APPOINTMENTS</h2>
