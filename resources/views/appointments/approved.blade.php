                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>                                            
                                            <a href="{{ route('appointment.form', $appointment->appointment_id ?? $appointment->id) }}" class="btn btn-sm btn-info">
                                                <i class="fas fa-eye"></i> Request an Appointment
                                            </a>
                                            <a href="{{ route('print.appointments') }}" class="btn btn-sm btn-secondary" target="_blank">
